    ...
    return (<Modal {...props} blur>
        <main className="max-w-[630px] mx-auto rounded-lg space-y-4 col">
            ...
            <a aria-label="support moth by following us on kickstarter"
                className="w-[400px] text-lg btn btn-secondary"
                target="_blank"
            ...
            <button aria-label="download offline version of the app"
                className="w-[400px] text-lg btn btn-accent"
            ...
            <a aria-label="leave feedback on the Moth feedback form"
                className="w-[400px] text-lg btn btn-primary"
                target="_blank"
                rel="noopener noreferrer"
                onClick={(e) => e.stopPropagation()}
            ...
            <footer>
                ...
                <div className="bg-base-200 max-h-[200px] overflow-auto p-2 mockup-code rounded-tl-none">
                    <pre data-prefix="$" className="text-info"><code>v1.0.2 - 5/4/25</code></pre>
                    ...
                    <pre data-prefix="$" className="text-info"><code>v1.0.1 - 4/4/25</code></pre>
